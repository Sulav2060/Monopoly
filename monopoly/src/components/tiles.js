...
export const tiles = {
  bottom: [
    // Group 1: TERAI CITIES (Dark Purple) – Cheapest
    {
      ...
      group: "dark-purple",
      title: "Janakpur",
      description: "Ancient city known for the sacred Janaki Temple, birthplace of goddess Sita.",
      price: 60,
    ...
    },
    {
      ...
      group: "dark-purple",
      title: "Birgunj",
      description: "Major commercial hub and industrial center in the Terai region.",
      price: 60,
    ...
    // Group 2: LAKES (Light Blue)
    {
      ...
      group: "light-blue",
      title: "Phewa",
      description: "Beautiful lake near Pokhara with serene views and peaceful boating.",
      price: 100,
    ...
    },
    {
      ...
      group: "light-blue",
      title: "Rara",
      description: "Pristine high-altitude lake in remote mountain region, nature's jewel.",
      price: 100,
    ...
    },
    {
      ...
      group: "light-blue",
      title: "Begnas",
      description: "Twin lakes offering peaceful mountain scenery and adventure activities.",
      price: 120,
  ...
  right: [
    // Group 3: TEMPLES (Pink)
    {
      ...
      group: "pink",
      title: "Pashupati",
      description: "Sacred Hindu temple and pilgrimage site, one of the holiest shrines.",
      price: 140,
    ...
    },
    {
      ...
      group: "pink",
      title: "Boudha",
      description: "Ancient Buddhist stupa and major spiritual center for meditation.",
      price: 140,
    ...
    },
    {
      ...
      group: "pink",
      title: "Swayambhu",
      description: "Iconic hilltop monastery with panoramic city views and spiritual significance.",
      price: 160,
    ...
    // Group 4: NATIONAL PARKS (Orange)
    {
      ...
      group: "orange",
      title: "Chitwan",
      description: "National park famous for tigers, rhinos, and diverse wildlife conservation.",
      price: 180,
    ...
    },
    {
      ...
      group: "orange",
      title: "Bardia",
      description: "Pristine wilderness area with diverse wildlife and untamed natural beauty.",
      price: 180,
    ...
    },
    {
      ...
      group: "orange",
      title: "Koshi Tappu",
      description: "Wetland sanctuary and haven for migratory birds, ecological treasure.",
      price: 200,
  ...
  top: [
    // Group 5: VALLEY CITIES (Red)
    {
      ...
      group: "red",
      title: "Kathmandu",
      description: "Capital city and cultural heart, ancient architecture and vibrant energy.",
      price: 220,
    ...
    },
    {
      ...
      group: "red",
      title: "Pokhara",
      description: "Tourist hotspot with stunning lakeside views and adventure activities.",
      price: 220,
    ...
    },
    {
      ...
      group: "red",
      title: "Patan",
      description: "Historic Durbar Square with stunning ancient architecture and temples.",
      price: 240,
    ...
    // Group 6: VIEWPOINTS (Yellow)
    {
      ...
      group: "yellow",
      title: "Nagarkot",
      description: "Mountain viewpoint famous for breathtaking sunrise over the Himalayas.",
      price: 260,
    ...
    
    {
      ...
      group: "yellow",
      title: "Sarangkot",
      description: "Paragliding hub offering thrilling flights with stunning mountain vistas.",
      price: 260,
    ...
    },
    {
      ...
      group: "yellow",
      title: "Dhulikhel",
      description: "Ancient trading city with well-preserved architecture from medieval era.",
      price: 280,
 ...
 left: [
  {
    ...
    group: "green",
    title: "Annapurna",
    description: "Iconic mountain massif with world-class trekking routes and stunning peaks.",
    price: 300,
    rent: [26, 130, 390, 900, 1100, 1275],
    houseCost: 60,
    rotation: -90,
  ...
  },
  {
    ...
    group: "green",
    title: "Langtang",
    description: "Popular trek destination near Kathmandu with pristine valleys and glaciers.",
    price: 300,
    rent: [26, 130, 390, 900, 1100, 1275],
    houseCost: 60,
    rotation: -90,
  ...
  },
  {
    ...
    group: "green",
    title: "Manaslu",
    description: "Remote eighth-highest mountain, challenging climb for experienced mountaineers.",
    price: 320,
  ...
  },
  {
    ...
    group: "dark-blue",
    title: "Makalu",
    description: "Fifth-highest peak in the world, demanding climb for elite mountaineers.",
    price: 350,
  ...
  },
  {
    ...
    group: "dark-blue",
    title: "Everest",
    description: "World's highest peak, ultimate mountaineering challenge and global icon.",
    price: 400,
